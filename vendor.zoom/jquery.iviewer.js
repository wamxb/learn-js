(function ($) {
    ...
    $iv.fn.extend({
         ...
         * zoom is calculated by formula: zoom_base * zoom_delta^rate 基础*增量^比率 ^幂
        ...
        zoom_by: function (delta) {
            ...
            // 下一个缩放 Math.pow(base, exponent); 幂
         ...
         * @param Number value zoom value to examine 缩放值检查
         **/
        find_closest_zoom_rate: function (value) {
            ...
            function div(val1, val2) { // divide 除
                return val1 / val2
            }

            function mul(val1, val2) { // multiplier 乘
                return val1 * val2
            }
            ...
            while (Math.abs(func(this.settings.zoom_base, Math.pow(mltplr, rate)) - value) > Math.abs(func(this.settings.zoom_base, Math.pow(mltplr, rate + 1)) - value)) {
                rate++;
            }
