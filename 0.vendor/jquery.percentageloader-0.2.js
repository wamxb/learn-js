...
(function() {
    ...
    window.PercentageLoader = function(el, params) {
      var settings, canvas, ctx, progress, cX, cY, tubeGrad, innerRadius, innerBarRadius, outerBarRadius,
            radius, startAngle, endAngle, completeAngle, setProgress,
            applyAngle, drawLoader, clipValue, ready, plugin;
